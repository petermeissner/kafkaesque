...
<img src="https://codecov.io/gh/`r codecov_user_name`/`r package_name`/branch/master/graph/badge.svg" alt="Codecov" />
...
One can add an install function that downloads the necessary JAR files after 
