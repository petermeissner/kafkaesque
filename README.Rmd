...
<img src="https://codecov.io/gh/`r codecov_user_name`/`r package_name`/branch/master/graph/badge.svg" alt="Codecov" /><!--<img src="http://www.r-pkg.org/badges/version/`r package_name`"><img src="http://cranlogs.r-pkg.org/badges/grand-total/`r package_name`"><img src="http://cranlogs.r-pkg.org/badges/`r package_name`">-->[![Check, Test, Lint](https://github.com/petermeissner/kafkaesque/actions/workflows/tests.yml/badge.svg)](https://github.com/petermeissner/kafkaesque/actions/workflows/tests.yml)
