...
``` r
Meissner P, Pirv M (2021). kafkaesque: Kafka R Bindings via 'rJava'. R package version 0.1.3.
```
...
```
    ...
    ## 
    ## $group.id
    ## [1] "75985173-47e6-4f99-a2a9-dfa797127dd9"
    ## 
    ## $value.deserializer
    ## [1] "org.apache.kafka.common.serialization.StringDeserializer"
    ## 
...
```
    ...
    ## $meta
    ## $meta$end_time
    ## [1] "2021-12-20 11:46:36 CET"
    ## 
    ## $meta$loop_counter
    ## [1] 4
    ## 
    ## $meta$start_time
    ## [1] "2021-12-20 11:46:35 CET"
    ## 
